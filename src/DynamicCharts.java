 ...
 */
public class DynamicCharts extends JPanel {
...
// seconds old...
    ...
    private void addTotalObservation(double y) {
        ...
        this.total.add(t, Math.cos(step*Math.PI*2/maxNumber));
    ...
    private void addFreeObservation(double y) {
        Millisecond t = new Millisecond();
        this.free.add(t, Math.sin(step*Math.PI*2/maxNumber));
        step  = step + 1 % maxNumber;
    }
    /**
     * The data generator.
...
public void actionPerformed(ActionEvent event) {
    ...
    public static void main(String[] args) {
        ...
        int maxAge = 10000;
        DynamicCharts panel = new DynamicCharts(maxAge);
